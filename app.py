...
---""")
    ...
    test_image = st.file_uploader("Upload your X_ray Image:")
    if test_image is not None:
        with tempfile.NamedTemporaryFile(delete=False, suffix=test_image.name) as tmpfile:
            tmpfile.write(test_image.read())
